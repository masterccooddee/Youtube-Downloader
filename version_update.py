...
class VersionUpdate:
    ...
    def fetch_latest_info(self):
        ...
        if response.status_code == 200:
            ...
            print(f"取得失敗，狀態碼: {response.status_code}")
            return False
    ...
    def download_latest(self, callback=None):
        ...
        try:
            with requests.get(download_url, stream=True) as r:
                ...
                with open(update_filename, 'wb') as f:
                    ...
                    for chunk in r.iter_content(chunk_size=131072):
                        ...
                        print(f"下載進度: {progress:.2f}%", end='\r')
            ...
            if sha256_checksum:
                ...
                print(f"計算出的 SHA256 校驗碼: {calculated_checksum}")
    ...
    def apply_update(self, callback=None):
        """執行更新的程式"""
        if not self.download_latest(callback):
            print("更新下載或驗證失敗，無法進行更新。")
            return
...
:: 強制刪除舊版
if exist "%OLD_APP%" del /f /q "%OLD_APP%"
